...
-- config.font = wezterm.font_with_fallback({ "Iosevka NF", "Iosevka Nerd Font" })
-- config.font = wezterm.font_with_fallback({ "ZedMono NF", "ZedMono Nerd Font" })
-- config.font = wezterm.font_with_fallback({ "MonaspiceNe NF", "MonaspiceNe Nerd Font" })
-- config.font = wezterm.font_with_fallback({ "BlexMono NF", "Blex Mono Nerd Font", "BlexMono Nerd Font" })

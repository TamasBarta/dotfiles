# Generated by Powerlevel10k configuration wizard on 2024-02-23 at 23:44 CET.
...
# round separators, round heads, round tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_FLUTTER_VISUAL_IDENTIFIER_EXPANSION='󱗆 '

...
# Disable suepr annoyingg typing assiting features
...
# Set selected keyboard layout with keyboardSwitcher
keyboardSwitcher select HungarianWin
...
# Increase the auto-hiding Dock delay, so it never shows unless you need it
